...
if __name__ == '__main__':
    ...
    # input parameters
    parser.add_argument('--train_img_path', type=str, default='D:\\works\\data\\resize_img1\\')
    parser.add_argument('--val_img_path', type=str, default='D:\\works\\data\\resize_img1\\')
    parser.add_argument('--test_img_path', type=str, default='D:\\works\\data\\resize_img1\\')
    parser.add_argument('--train_csv_file', type=str, default='labels_train_all_10.csv')
    parser.add_argument('--val_csv_file', type=str, default='labels_test_all_10.csv')
    parser.add_argument('--test_csv_file', type=str, default='labels_test_all_10.csv')
    ...
    # misc
    parser.add_argument('--ckpt_path', type=str, default='ckpts_10/')
